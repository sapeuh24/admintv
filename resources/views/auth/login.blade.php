    ...
    <div id="auth">
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="{{ route('/') }}">AdminTV</a>
                    </div>
                    <h1 class="auth-title">Iniciar sesión</h1>
                    <p class="auth-subtitle mb-5">¡Bienvenido al nuevo AdminTV! Inicia sesión para continuar.</p>
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p><a class="font-bold" href="auth-forgot-password.html">¿Olvidó contraseña?</a></p>
                    </div>
                </div>
            </div>
